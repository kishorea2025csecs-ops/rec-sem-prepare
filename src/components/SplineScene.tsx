...
export const SplineScene: React.FC<SplineSceneProps> = ({ scene, className, onLoad }) => {
  ...
  if (error) {
    return (
      <div
        className={`${className} flex items-center justify-center bg-black/20 backdrop-blur-sm border border-white/5 rounded-3xl p-8 text-center`}
      >
